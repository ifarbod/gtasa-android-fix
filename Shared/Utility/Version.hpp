...
#define SAO_VERSION_COMMA_RC SAO_VERSION_MAJOR,SAO_VERSION_MINOR,SAO_VERSION_PATCH,0
    ...
    #define SAO_VERSION_STR "v" SAO_STRINGIZE(SAO_VERSION_MAJOR) "." SAO_STRINGIZE(SAO_VERSION_MINOR) "." SAO_STRINGIZE(SAO_VERSION_PATCH) "-" SAO_VERSION_PRE_RELEASE_TYPE "." SAO_STRINGIZE(SAO_VERSION_PRE_RELEASE)
	#define SAO_VERSION_STR_NOV SAO_STRINGIZE(SAO_VERSION_MAJOR) "." SAO_STRINGIZE(SAO_VERSION_MINOR) "." SAO_STRINGIZE(SAO_VERSION_PATCH) "-" SAO_VERSION_PRE_RELEASE_TYPE "." SAO_STRINGIZE(SAO_VERSION_PRE_RELEASE)
#else
    #define SAO_VERSION_STR "v" SAO_STRINGIZE(SAO_VERSION_MAJOR) "." SAO_STRINGIZE(SAO_VERSION_MINOR) "." SAO_STRINGIZE(SAO_VERSION_PATCH)
	#define SAO_VERSION_STR_NOV SAO_STRINGIZE(SAO_VERSION_MAJOR) "." SAO_STRINGIZE(SAO_VERSION_MINOR) "." SAO_STRINGIZE(SAO_VERSION_PATCH)
#endif

#define SAO_VERSION_STR_RC SAO_STRINGIZE(SAO_VERSION_DOT_RC)
