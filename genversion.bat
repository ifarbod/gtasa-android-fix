...
:: Client\Version.h
utils\genver Client\Version.h %VERSION_MAJOR% %VERSION_MINOR% %VERSION_PATCH% %VERSION_PRE_RELEASE_TYPE% %VERSION_PRE_RELEASE%

:: Server\Version.h
utils\genver Server\Version.h %VERSION_MAJOR% %VERSION_MINOR% %VERSION_PATCH% %VERSION_PRE_RELEASE_TYPE% %VERSION_PRE_RELEASE%
