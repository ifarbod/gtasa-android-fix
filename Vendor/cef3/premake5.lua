project "CEF"
    ...
    defines { "V8_DEPRECATION_WARNINGS", "WIN32", "_WINDOWS", "PSAPI_VERSION=1", "_CRT_RAND_S", "CERT_CHAIN_PARA_HAS_EXTRA_FIELDS", "WIN32_LEAN_AND_MEAN",
        ...
        "ENABLE_NOTIFICATIONS", "ENABLE_HIDPI=1", "ENABLE_EGLIMAGE=1", "__STD_C", "NTDDI_VERSION=0x06020000",
