...
-- Modified by Aster Jian for CtNorth
...
function doit ()
	...
	if not flags['S'] then
		...
		-- CtNorth: Add CtNorth::String Support in tolua++
		_basic['String'] = 'CtNorthstring'
		_basic['CtNorth::String'] = 'CtNorthstring'
		_basic_ctype.CtNorthstring = 'const char*'
	end
